...
# pyramid2000 <- ggplot(data = pyramid2000data, aes(x = Age, y = group_est, fill = Sex))+
...
pyramid2000 <- plot_ly(pyramid2000data,x = pyramid2000data$group_est, y = pyramid2000data$Age, 
        color = pyramid2000data$Sex, type = 'bar', orientation = 'h', colors = c('red','navy'),
        hoverinfo = 'text+name',text = pyramid2000data$abs_group_est)%>% 
  layout(bargap = 0.1, barmode = 'overlay',
         annotations = list(x = -5, y = 17,text = "Total Population: 107",showarrow = FALSE),
         xaxis = list(title = "Population 2000",tickmode = 'array', tickvals = c(-10,-5,0,5,10),ticktext = c("10","5","0","5","10")),
